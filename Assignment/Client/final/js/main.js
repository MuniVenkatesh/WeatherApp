...
var WeatherFromDB=React.createClass({displayName: "WeatherFromDB",
  getInitialState:function(){
    var exist=[],
        remaining=cities;
    $.ajax({
            ...
            this.state.data.map(function(d){
              return (
                   ...
                   React.createElement("div", {className: "col-lg-10"}, 
                    React.createElement("button", {className: "btn btn-link", type: "submit", value: d.name, "data-target": "#full", "data-toggle": "modal", onClick: self.viewMore}, d.name, ",", d.sys.country), 
                    ...
                    React.createElement("button", {className: "btn btn-info", type: "submit", value: d.name, onClick: self.addDB}, "Refresh")
                    )
                   )
                );
              }), 
              this.state.rem.map(function(d){
                return (
                     React.createElement("div", {className: "col-lg-12 well"}, 
                      ...
                      React.createElement("div", {className: "col-lg-2"}, 
                      React.createElement("button", {className: "btn btn-info", type: "submit", value: d, onClick: self.addDB}, "Refresh")
                      )
                     )
                  );
                })
...
React.render(React.createElement(WeatherFromDB, null),document.getElementById("app"));
},{"react":156}]},{},[157]);
